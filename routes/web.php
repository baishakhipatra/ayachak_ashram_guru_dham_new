...
Route::name('front.')->group(function () {
        // Route::get('/login','Front\FrontController@showLoginForm')->name('login');
        // Route::post('/check', 'Front\FrontController@login')->name('check'); 
        // Route::get('/register','Front\FrontController@register')->name('register');
        // Route::post('/create', 'Front\FrontController@create')->name('create');
        // Route::post('/logout','Front\FrontController@logout')->name('logout'); 
